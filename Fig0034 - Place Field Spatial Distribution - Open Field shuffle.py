...
loc = os.path.join(figpath, code_id, 'open field shuffle')
mkdir(loc)
...
FieldDisImage.plot_figure(maze_type=1, data=Data, 
                    save_loc=loc, file_name='Open Field-11095-for maze 1',
                    twin_data = None, 
...
FieldDisImage.plot_figure(maze_type=2, data=Data, 
                    save_loc=loc, file_name='Open Field-11095-for maze 2',
                    twin_data = None, 
                    cp_args = {'labels':labels},
                    ip_args = {})
...
dates = [20220820, 20220822, 20220824, 20220826, 20220828, 20220830]
...
labels = ['Day 4', 'Day 5', 'Day 6',
          'Day 7', 'Day 8', 'Day 9']
FieldDisImage.plot_figure(maze_type=1, data=Data, 
                    save_loc=loc, file_name='Open Field-11092-for maze 1',
                    twin_data = None, 
                    cp_args = {'labels':labels},
                    ip_args = {})
...
labels = ['Day 4', 'Day 5', 'Day 6',
          'Day 7', 'Day 8', 'Day 9']
FieldDisImage.plot_figure(maze_type=2, data=Data, 
                    save_loc=loc, file_name='Open Field-11092-for maze 2',
                    twin_data = None, 
                    cp_args = {'labels':labels},
                    ip_args = {})
