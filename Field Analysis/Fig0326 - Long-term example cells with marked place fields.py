...
dates = [ 20230806, 20230808, 20230810, 20230812, 
          ...
          20230930]
#dates = [20230426, 20230428, 20230430, 20230502, 20230504, 20230506, 20230508,20230510, 20230512, 20230515, 20230517, 20230519, 20230521]
        # [20230806, 20230808, 20230810, 20230812, 20230814, 20230816, 20230818, 20230820, 20230822, 20230824, 20230827, 20230829, 20230901]

#dates = [20230703, 20230705, 20230707, 20230709, 20230711, 20230713,20230715, 20230717, 20230719, 20230721, 20230724, 20230726,20230728]
...
for n in range(26, 1, -1):
    ...
    print(n, idx)
    p = join(loc, '10224-Stage 1+2-Maze 1', str( n)+' Cells')
    mkdir(p)
