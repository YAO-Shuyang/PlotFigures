...
idx = idx = np.where((SubData['Stage'] == 'Stage 1'))[0]
...
data_m1_d1 = SubData['Field Number'][np.where((SubData['Maze Type']=='Maze 1')&(SubData['Training Day']=='Day 1')&(SubData['Stage'] == 'Stage 1'))[0]]
data_m1_d10 = SubData['Field Number'][np.where((SubData['Maze Type']=='Maze 1')&(SubData['Training Day']=='>=Day 10')&(SubData['Stage'] == 'Stage 2'))[0]]
data_m2_d1 = SubData['Field Number'][np.where((SubData['Maze Type']=='Maze 2')&(SubData['Training Day']=='Day 1')&(SubData['Stage'] == 'Stage 2'))[0]]
data_m2_d10 = SubData['Field Number'][np.where((SubData['Maze Type']=='Maze 2')&(SubData['Training Day']=='>=Day 10')&(SubData['Stage'] == 'Stage 2'))[0]]
...
data_m1 = SubData['Field Number'][np.where((SubData['Maze Type']=='Maze 1')&
                                           ((SubData['Stage'] != 'Stage 1') | (SubData['Training Day'] != 'Day 6')))[0]]
...
data_m2 = SubData['Field Number'][np.where((SubData['Maze Type']=='Maze 2')&(SubData['Stage'] == 'Stage 2'))[0]]
